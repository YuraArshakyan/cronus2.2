            ...
            <div class="member-profile-wrapper">
                <div class="row align-items-center">
                    <div class="col-lg-4 col-xl-3 col-md-4">
                        <div class="member-profile-img bg-cover bg-center" style="background-image: url('assets/img/team/3.jpg')"></div>
                    </div>
                    <div class="col-lg-8 d-sm-flex justify-content-between col-md-8 col-xl-9">
                        <div class="member-info">
                            <h2>Jone Deo</h2>
                            <span>Delivery Man</span>
                            <p>Business blogging is as essential to marketing a business as the yellowpages. A business blog is a marketing channel that helps businesses increase visibility online</p>
