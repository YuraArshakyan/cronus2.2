                ...
                <div class="error-content">
                    ...
                    @if($id == 1)
                        <form action="{{url('update' . '/' . 1 . '/' . 1)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div calss = "carousel_edit" style="width: 300px; margin-bottom: 4px">
                                @foreach($slides['slide1'] as $slide)
                                    <img src="{{asset('assets/img/home1/'. $slide->img) }}" style="padding: 4px">
                                    <label class="file_upload" style="width: 100%; text-align: center">
                                        <input type="file" name="slide1" style="display: none"/>
                                ...
                                <hr>
                            <div calss = "carousel_edit" style="width: 300px">
                                @foreach($slides['slide2'] as $slide)
                                    <img src="{{asset('assets/img/home1/'. $slide->img) }}" style="padding: 4px">
                                    <label class="file_upload" style="width: 100%; text-align: center">
                                        <input type="file" name="slide2" style="display: none"/>
                                        <a type="file" data-animation-in="fadeInRight" data-delay-in="0.8" class="theme-btn border-style me-sm-4 mt-4 animated" style="width: 100%; text-align: center">Change</a>
                                    </label>
                                @endforeach
                            </div>
                                                ...
                                                <form action="{{url('update' . '/' . 2 . '/' . 1)}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="photo_overview">
                                                        @foreach($photos as $photo)
                                                            <img src="{{asset('assets/img/'. $photo->overview_photos) }}" style="width: 300px; display: flex">
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        <div class="single-personal-info">
                                                            <textarea name="overview_text" id="message">{{$text->overview}}</textarea>
                                                        </div>
                                                    </div>
                    ...
                    @endif
                        ...
                        @if($id == 3)
                            @foreach($what_we_do[$count.$count] as $text)
                                <div class="container">
                                    <div class="row pt-5">
                                        <div class="col-12 col-lg-12">
                                            <div class="contact-form">
                                                ...
                                                <form action="{{url('update' . '/' . 3 . '/' . $count)}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    @method('PUT')
                                                    <div class="photo_overview">
                                                        @foreach($what_we_do[$count] as $photo)
                                                            <img src="{{asset('assets/img/services/'.$photo) }}" style="width: 300px; display: flex">
                                                            <label class="file_upload" style="width: 100%; display: flex">
                                                    ...
                                                    @foreach($what_we_do[$count.$count.$count] as $title)
                                                        <div class="col-md-12 col-12">
                                                            <div class="single-personal-info">
                                                                <input type="text" id="fname" placeholder="Title" name="what_we_do_title" value="{{$title}}">
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                    <div class="col-md-12 col-12">
                                                        <div class="single-personal-info">
                                                            <textarea id="message" name="what_we_do_text">{{$text}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 col-12 text-center">
                        ...
                        @if($id == 4)
                            @foreach($team[$count.$count.$count] as $title)
                                <div class="container">
                                    <div class="row pt-5">
                                        <div class="col-12 col-lg-12">
                                            <div class="contact-form">
                                                <form action="{{url('update' . '/' . 4 . '/' . $count)}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    @csrf
                                                    <div class="photo_overview">
                                                        @foreach($team[$count] as $photo)
                                                            <img src="{{asset('assets/img/team/'.$photo) }}" style="width: 300px; display: flex">
                                                            <label class="file_upload" style="width: 100%; display: flex">
                                                    ...
                                                    @foreach($team[$count.$count] as $text)
                                                        <div class="col-md-12 col-12">
                                                            <div class="single-personal-info">
                                                                <input type="text" id="text" name="text" placeholder="Title" value="{{$text}}">
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                    <div class="col-md-12 col-12">
                                                        <div class="single-personal-info">
                                                            <input type="text" id="fname" name="title" placeholder="Title" value="{{$title}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 col-12 text-center">
                                                        <button type="submit"><input class="submit-btn" type="submit" value="Submit"></button>
                        ...
                        @if($id == 5)
                            @foreach($contact[$count.$count] as $item2)
                                <div class="container">
                                    <div class="row pt-5">
                                        <div class="col-12 col-lg-12">
                                            <div class="contact-form">
                                                <form action="{{url('update' . '/' . 5 . '/' . $count)}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    @foreach($contact[$count] as $item)
                                                        <div class="col-md-12 col-12">
                                                            <div class="single-personal-info">
                                                                <textarea type="text" name="Text1_of_contact" id="fname" placeholder="Title">{{$item}}</textarea>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                    @if($count != 3)
                                                        <div class="col-md-12 col-12">
                                                            <div class="single-personal-info">
                                                                <input type="text" name="minor_text" id="fname" placeholder="Title" value="{{$item2}}">
                                                            </div>
                                                        </div>
                                                    @endif
                                                    <div class="col-md-12 col-12 text-center">
