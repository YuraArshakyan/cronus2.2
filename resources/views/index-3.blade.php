...
<body class="body-wrapper">
    ...
    <div class="offset-menu">
        ...
        <div class="offset-menu-wrapper text-white">
            ...
            <div class="offset-menu-section">
                <h3>About Us</h3>
                <p>Transland is the world’s driving worldwide coordinations supplier — we uphold industry and exchange the worldwide trade of merchandise through land transport.</p>
                <a href="contact.html" class="theme-btn minimal-btn mt-30">Consultation <i class="fas fa-arrow-right"></i></a>
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-xl-2 col-lg-3 col-6 ps-lg-0 text-end">
                        <div class="header-btn-cta">
                            <a href="contact.html" class="theme-btn">Get a quote <i class="ms-2 fal fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-9 mt-5 mt-lg-0 order-2 order-lg-1 text-center text-lg-start">
                            <div class="hero-contents text-white">
                                ...
                                <h1 class="animated" data-animation-in="fadeInLeft" data-delay-in="0.3">Moving Never <br>Looked so Superior</h1>
                                <a href="services.html" class="theme-btn animated" data-animation-in="fadeInLeft" data-delay-in="0.9">Service we provide <i class="fas fa-arrow-right"></i></a>
                                <a href="about.html" class="theme-btn minimal-btn animated" data-animation-in="fadeInLeft" data-delay-in="0.6">learn more <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 ps-lg-5">
                    ...
                    <div class="about-info-contents">
                        <p>This shortage is being seen in both the airline and the cargo industries. With such a small pool of applicants to choose from, these two sectors are battling to get the most qualified available candidates. Many pilots are increasingly being wooed to get behind the controls of passenger planes over cargo flights</p>
                        <p>Just as we’ve found with the truck driver shortage, the impetus behind skilled labor leaving is many-fold. Demographics play a large role—a massive amount of pilots are expected to hang up their hats in the next few years </p>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-feature-item">
                        ...
                        <div class="content">
                            ...
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantiu doloremque laudantium totam remap</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="col-xl-6 col-lg-6 col-12 pe-xl-5">
                    ...
                    <div class="skill-wrapper">
                        ...
                        <div class="single-progress-bar">
                            ...
                            <div class="progress">
                                <div class="progress-bar wow fadeInLeft" data-wow-duration="2s" data-wow-delay=".9s" role="progressbar" style="width: 98%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 ps-lg-5 mt-5 mt-lg-0 col-lg-6 col-12">
                    <div class="skills-video d-flex justify-content-center align-items-center bg-cover bg-center" style="background-image: url('assets/img/faq-video-pup.jpg')">
    ...
    <section class="faq-wrapper section-padding section-bg">
        ...
        <div class="faq-banner-half bg-cover d-none d-lg-block" style="background-image: url('assets/img/mask-bg.jpg')"></div>
    </section>
